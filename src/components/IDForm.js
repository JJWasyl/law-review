                    ...
                    <form noValidate autoComplete="off">
                        <Container maxWidth="sm" style={styles.textfields}>
                            ...
                            <TextField
                                ...
                                helperText={this.state.error.last_name ? 'Required' : ' '}                                
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (this.state.ID_details.name !== ""
                          ...
                          let state_copy = Object.assign({}, this.state);
                          if(this.state.ID_details.name === "") { state_copy.error.name = true }
                          if(this.state.ID_details.last_name === "") { state_copy.error.last_name = true }
                          this.setState(state_copy);
                        }
                      }}
                    >
